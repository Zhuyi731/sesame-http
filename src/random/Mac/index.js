...
class MacRandomGenerator extends RandomGenerator {
    constructor() {
        super();
        //default options
        this.defaultOptions = {
            range: "00-FF:00-FF:00-FF:00-FF:00-FF:00-FF"
        };
    ...
    random(opt) {
        ...
        while (strLen--) {
            str += this.options.charPool[randomNumber.random({ range: [0, charPoolLen] })];
        }
...
module.exports = new MacRandomGenerator();